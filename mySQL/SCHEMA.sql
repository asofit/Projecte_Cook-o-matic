...
CREATE TABLE COMANDES (
	...
	CAMBRER			SMALLINT (3) 	NOT NULL,
	
	PRIMARY KEY (COMANDA_ID),
	CONSTRAINT `COMANDES_FK_TAULES` FOREIGN KEY (TAULA) REFERENCES TAULES (TAULA_ID),
	CONSTRAINT `COMANDES_FK_CAMBRERS` FOREIGN KEY (CAMBRER) REFERENCES CAMBRERS (CAMBRER_ID)
);
...
CREATE TABLE LINIES_COMANDA (
	...
	PLAT			MEDIUMINT(7)	NOT NULL,
	QUANTITAT		SMALLINT(3)		NOT NULL,
	ESTAT			ENUM('EN_PREPARACIO','PREPARADA') NOT NULL,
